...
from face3d.mesh.transform import to_image
...
def export_keypoints_from_BFM_and_fg(pos_bfm, fg_obj_path, uv_coords, out_path_bfm = 'kpt_vertices_bfm.ply', out_path_fg = 'kpt_vertices_fg.ply'):
	# BFM
	bfm_kpt_ind = np.loadtxt('../Data/uv-data/bfm_kpt_ind.txt').astype(np.int32) # same as bfm.kpt_ind
...
def validate_TrainData():
	...
	data = TrainData(
					...
					weight_mask_path = '../Data/uv-data/weight_mask_final.jpg', #'../Data/uv-data/facegen_final_mask.png', 
					)
