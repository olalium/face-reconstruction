...
class prediction_evaluater:
	...
	def __call__(self, predicted_vertices, ground_truth_vertices, alignment_data = None, save_vertices = False, save_output = 'aligned_vertices.obj'):
...
if __name__ == '__main__':
	...
	par.add_argument('--florence_path',default='../Data/Florence/files.txt',type=str,help='The path to the florence dataset description file')
	par.add_argument('--save_file',default='./evaluation_results.txt',type=str,help='The path to the file where the results are saved')
